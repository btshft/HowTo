...
![img](https://github.com/rex-core/HowTo/blob/master/js/img/curry-function-closures.png)
...
Рассмотренные техники, в первую очередь, — это часть философии функционального программирования. 
